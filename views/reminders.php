...
<header class="bg-dark text-white p-3">
    <div class="container">
        <h1 class="h3">Podsetnici za vozilo: <?php echo htmlspecialchars($reminders[0]['brand'] . ' ' . $reminders[0]['model']); ?></h1>
    </div>
</header>

<div class="container mt-4">
    <?php if (empty($reminders)): ?>
        <p>Nema evidentiranih podsetnika za ovo vozilo.</p>
    <?php else: ?>
        <ul class="list-group">
            <?php foreach ($reminders as $reminder): ?>
                <li class="list-group-item">
                    <?php echo htmlspecialchars($reminder['reminder_date'] . ' — ' . $reminder['note']); ?>
                    <a href="edit_reminder.php?id=<?php echo $reminder['id']; ?>" class="btn btn-sm btn-outline-primary ms-2">Izmeni</a>
    ...
    <div class="mt-3">
        <a href="add_reminder.php?car_id=<?php echo $carId; ?>" class="btn btn-success">Dodaj podsetnik</a>
